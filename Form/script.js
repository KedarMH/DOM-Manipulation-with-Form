...
heading.innerHTML = "DOM Manipulation with Form"
...
function createMultiSelect() {
    ...
    var opt1 = new Option('Dosa', 'Dosa');

    var opt2 = new Option('Idli', 'Idli');
    var opt3 = new Option('Upma', 'Upma');
    var opt4 = new Option('Maggi', 'Maggi');
    var opt5 = new Option('Pulav', 'Pulav');
    opt2.selected = true;
...
function createState() {
    ...
    select.id = 'state'
    select.setAttribute('class', 'form-control col-6')
    var opt1 = new Option('Karnataka', 'Karnataka');

    opt1.selected = true;
    var opt2 = new Option('Andhra Pradesh', 'Andhra Pradesh');
    var opt3 = new Option('Tamilnadu', 'Tamilnadu');
    var opt4 = new Option('Kerala', 'Kerala');
    var opt5 = new Option('Maharashtra', 'Maharashtra');
    var opt6 = new Option('Goa', 'Goa');
    var opt7 = new Option('Orissa', 'Orissa');
...
function createCountry() {
    ...
    opt1.selected = true;
    var opt2 = new Option('Nepal', 'Nepal');
    var opt3 = new Option('Sri Lanka', 'Sri Lanka');
    var opt4 = new Option(' Indonesia', 'Indonesia ');
